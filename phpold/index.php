...
<html >
    ...
    <body >
        <div class="container" align="center">
            <h1 class="jumbotron text-center">Sistema de Cadastro</h1><br>

            <p><a href="form-add.php" class="btn btn-default">Adicionar Usuário</a></p><br>
        ...
        <table width="50%" border="1" class="table" ><br>
